...
export default function InspectionMatters() {
  ...
  const protocols = [
    { label: "Mechanical", detail: "Engine, Transmission & Drivetrain Performance" },
    ...
    { label: "Documentation", detail: "Historical Validation & Paperwork Audit" },
  ];

  return (
    <section className="relative py-10  bg-[#0a0a0a] overflow-hidden border-t border-white/5">
            ...
            <div className="lg:sticky lg:top-24">
              ...
              <div className="space-y-5 md:space-y-6 text-third/70 text-sm md:text-lg leading-relaxed max-w-md">
                ...
                <p className="text-[13px] md:text-[15px] font-light leading-relaxed border-l border-fourth/40 pl-4 md:pl-6">
                  ...
                  data-driven protocol. Transparency is the core of our ecosystem.
                </p>
              </div>

              {/* Terminal */}
              <div className="mt-8 md:mt-12 p-3 md:p-4 bg-black border border-white/10 rounded-md font-mono text-[12px] md:text-[14px] text-fourth/60">
                <span className="text-white">SYSTEM_NOTE:</span> Inspection adds transparency — not guarantees.
              </div>
            </div>
          </div>
