// app/help/avx-inspection/[slug]/page.jsx
// ─────────────────────────────────────────────────────────────────────────────
// Article Detail Page
// Route: /help/avx-inspection/[slug]
//
// Usage in category page (link to this page):
//   import Link from "next/link";
//   <Link href={`/help/avx-inspection/${article.slug}`}>…</Link>
// ─────────────────────────────────────────────────────────────────────────────
...
import { articles, tagStyles } from "@/data/articles.data"; // adjust path as needed
...
export default function ArticleDetailPage() {
  ...
  if (!article) {
    return (
      <section className="relative min-h-screen py-16 px-4 sm:px-6 overflow-hidden flex items-center justify-center">
    ...
    <section className="relative min-h-screen py-16 px-4 sm:px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          {/* ── BREADCRUMB ──────────────────────────── */}
          <div
            className="flex items-center gap-2 text-[10px] uppercase tracking-[0.35em] font-bold mb-10"
          ...
          {(prevArticle || nextArticle) && (
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                {prevArticle ? (
                  <Link
                    href={`/help/avx-inspection/${prevArticle.slug}`}
              ...
              <div>
                {nextArticle ? (
                  <Link
                    href={`/help/avx-inspection/${nextArticle.slug}`}
