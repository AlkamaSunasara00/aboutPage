          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 sm:px-8 py-5 border-b" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
            <div className="relative flex-1 max-w-xs">
              ...
              <input
                ...
                className="w-full pl-8 pr-4 py-2 rounded-xl text-sm bg-white/4 border text-primary placeholder-third/30 outline-none focus:border-fourth/40 transition-colors duration-200"
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              {FILTERS.map((f) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-lg text-xs font-bold uppercase tracking-[0.15em] transition-all duration-200 ${
                    activeFilter === f ? "bg-fourth/15 text-fourth border border-fourth/25" : "text-third/40 hover:text-third/70 border border-transparent"
                  }`}
                >
                  {f}
                  {counts[f] > 0 && (
                      ...
                      {ticket.status !== "Closed" ? (
                        <div className="mt-5 flex items-center justify-center gap-2">
                          <input
                            ...
                            className="flex-1 px-4 py-2.5 rounded-xl text-sm bg-white/4 border text-primary placeholder-third/25 outline-none focus:border-fourth/40 transition-colors duration-200"
                            style={{ borderColor: "rgba(255,255,255,0.07)" }}
                          />
                          <button
