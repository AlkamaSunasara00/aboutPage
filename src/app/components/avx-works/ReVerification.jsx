    ...
    return (
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-5">
                ...
                <p className="text-sm italic text-[var(--color-third)] mt-6 border-l border-fourth pl-4">
            ...
            <div className="lg:col-span-7 space-y-6">
                ...
                <div className="relative rounded-2xl bg-[var(--color-secondary)] p-7 md:p-8 flex flex-col md:flex-row gap-6 items-start md:items-center">
                    ...
                    {/* arrow */}
                    <button className="shrink-0 p-3 rounded-xl border border-primary/10 text-[var(--color-third)] transition-all duration-300 group-hover:text-primary group-hover:border-fourth group-hover:bg-fourth/10">
